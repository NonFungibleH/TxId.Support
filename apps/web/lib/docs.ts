...
export const DOCS: Doc[] = [
...

  {
    ...
    content: [
      ...
      { type: "callout", variant: "info", title: "Free tier", text: "The free plan includes 50 conversations per month, enough to test the full product and validate it with real users before deciding to upgrade." },
