  ...
  return (
    <SolutionLayout
      s={{
        ...
        delivers: [
          "Every claim backed by a live on-chain read with its source cited; verified fact kept distinct from interpretation",
          "Each case filed as an auditable trail: the question, the chain evidence, the reasoning, the resolution",
          "OFAC sanctions screening and contract verification on request, cited to the on-chain source",
          "Escalations reach your existing tools with the completed investigation attached",
          "Read-only by design: no custody, no keys, no financial advice, ever",
        ],
        visual: <RecordVisual />,
