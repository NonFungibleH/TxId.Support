...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/resolve`,      lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/console`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
