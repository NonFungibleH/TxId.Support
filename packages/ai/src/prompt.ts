    ...
    parts.push(
      ...
      (beta.bugs
        ? `\n**Bug reports are a separate thing, and shorter.**\n` +
          ...
          `Then call create_support_ticket with reason "bug" and a summary in THEIR words. Confirm it is logged in one short line and ask if there is anything else you can help with, so they know the report is complete and can carry on. Never promise a fix or a timeline: that is the team's to give, not yours.\n` +
