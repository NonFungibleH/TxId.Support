      ...
      parts.push(
        ...
        (isSolana
          ...
          : `- Never ask the user for a transaction hash or any technical data — look it up yourself\n` +
            ...
            `- If \`method\` is ABSENT on a successful transaction to one of this protocol's own contracts, still describe what you CAN see (the \`events\` and \`tokenTransfers\` usually reveal the action) and state that the exact function name isn't decodable because the contract's ABI hasn't been uploaded in the dashboard yet — offer to flag it for the team. NEVER ask the user what they were doing, and never say "from the hash alone I can't tell" — you have the receipt.\n` +
